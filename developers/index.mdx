...
flowchart LR
    ...
    Editor -->|1. Finaliza laudo| API
    API -->|2. Seleciona protocolo| HL7
    API -->|2. Seleciona protocolo| DICOM
    API -->|2. Seleciona protocolo| MV

    HL7 -->|3. ORU^R01 via MLLP| VPN
    DICOM -->|3. STOW-RS via HTTPS| VPN
    MV -->|3. XML via HTTPS| VPN

    VPN -->|4. Entrega| PACS
    PACS -->|5. ACK/Response| API
```
